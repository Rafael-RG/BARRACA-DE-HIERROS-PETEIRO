        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Administra precios de productos</p>
            </div>
              ...
              {isInitializingGoogle ? (
                ...
                <>
                  <button
                    ...
                    className="w-full bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 px-4 rounded-lg border-2 border-gray-300 transition-colors flex items-center justify-center gap-3"
                  >
              ...
              <AnimatePresence>
                {authError && (
                  <motion.div
                    ...
                    className="flex items-start gap-2 text-red-600 text-sm bg-red-50 p-3 rounded-lg"
                  >
